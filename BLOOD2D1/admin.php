...
<html lang="en">
  ...
  <?php
   ...
   $query=mysqli_query($con,"SELECT * FROM mytable WHERE id !='$id'");
     ...
     ?>
      ...
      <tbody>
        <tr>
          ...
          <td><a type="edit" class="btn btn-success" href="updateprofile1.php?id=<?php echo $row["id"]  ?>"  ><span class="spinner-border spinner-border-sm"></span>Edit Profile</a>
           <a type="edit" class="btn btn-success" href="deleteprofile1.php?id=<?php echo $row["id"]  ?>"  ><span class="spinner-border spinner-border-sm"></span>Delete Profile</a></td>
